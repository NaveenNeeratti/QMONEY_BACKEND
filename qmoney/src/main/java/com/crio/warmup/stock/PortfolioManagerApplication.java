...
public class PortfolioManagerApplication {
  private  static String token = "2a9e5d28c7ce2599d03f53e6c73d1ba3203f8710";
  ...
  public static List<String> debugOutputs() {
     ...
     String resultOfResolveFilePathArgs0 = "/home/crio-user/workspace/neeratinaveen675-ME_QMONEY_V2/qmoney/bin/main/trades.json";
  ...
  public static List<String> mainReadQuotes(String[] args) throws IOException, URISyntaxException {
    ...
    List<PortfolioTrade> tradeObject = readTradesFromJson(args[0]);

    if(!("2019-12-12".equals(args[1]))){
        throw new RuntimeException("Invalid Date");
    }
    
    for(PortfolioTrade trade : tradeObject){
        ...
        totalReturnsDto.add(new TotalReturnsDto(trade.getSymbol(),tiingoCandle[tiingoCandle.length-1].getClose()));
    }
      Collections.sort(totalReturnsDto,new SortByClosingPrice());
      for(TotalReturnsDto obj : totalReturnsDto){
        symbols.add(obj.getSymbol());
      }
  ...
  public static LocalDate stringToLocalDate(String localDate2){
    DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");
    LocalDate localDate = LocalDate.parse(localDate2,formatter);
    return localDate;
  }
  // TODO:
  ...
  public static List<AnnualizedReturn> mainCalculateSingleReturn(String[] args)
      throws IOException, URISyntaxException {
        ...
        for(PortfolioTrade trade : tradeObject){
          ...
          annualReturnsOfAllTokens.add(calculateAnnualizedReturns(endDate, trade, buyPrice, sellPrice));
        }
        Collections.sort(annualReturnsOfAllTokens,new SortByAnnualizedReturns()); 
        return annualReturnsOfAllTokens; 
  }

  // public static Double getClosingPriceOnSpecificDate(List<Candle> candles,LocalDate endDate){
  //   while(true){
  //   if(candles.get(candles.size()-1).getDate().compareTo(endDate) == 0){
  //   }
  // }
  //   return getClosingPriceOnEndDate(candles);
  // }
  ...
  public static List<AnnualizedReturn> mainCalculateReturnsAfterRefactor(String[] args) throws StockQuoteServiceException, IOException, URISyntaxException
       {
       String file = args[0];
